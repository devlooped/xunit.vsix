...
namespace Xunit
{
    internal class VsixInstaller
    {
        public static void Initialize(string devEnvDir, string visualStudioVersion, string rootSuffix)
        {
            ...
            var extensionsPath = VsSetup.GetExtensionsPath(new Version(visualStudioVersion), rootSuffix);
        ...
        /// </summary>
        private static void Install(string vsixFile, string devEnvDir, string visualStudioVersion, string rootSuffix)
        {
        ...
        private const string PkgTemplate = @"[$RootKey$\BindingPaths\{FFFFFFFF-EEEE-DDDD-CCCC-BBBBBBAAAAAA}]
";
        private const string VsixTemplate = @"<?xml version='1.0' encoding='utf-8'?>
