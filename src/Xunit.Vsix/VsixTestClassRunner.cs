...
namespace Xunit
{
    class VsixTestClassRunner : XunitTestClassRunner
    {
        ...
        {
            return new VsixTestMethodRunner(_vsClient, testMethod, Class, method, testCases, DiagnosticMessageSink, MessageBus, new ExceptionAggregator(Aggregator), CancellationTokenSource).RunAsync();
        }
