...
namespace Xunit
{
	...
	static class SpecialNames
	{
		...
		/// assembly name.
		/// </summary>
		public const string ThisAssembly = "xunit.vsx";

		/// <summary>
		/// Type name of the <see cref="Xunit.VsxFactDiscoverer"/> class.
		/// </summary>
		public const string VsxFactDiscoverer = "Xunit.VsxFactDiscoverer";

		public static class VsxAttribute
		{
			///// <summary>
