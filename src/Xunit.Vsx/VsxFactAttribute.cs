...
namespace Xunit
{
    ...
    /// </summary>
    [XunitTestCaseDiscoverer(SpecialNames.VsxFactDiscoverer, SpecialNames.ThisAssembly)]
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = false)]
	public sealed class VsxFactAttribute : FactAttribute, IVsxAttribute
	{
		/// <summary>
		/// Sets default values for properties other than the VS version.
		/// </summary>
		public VsxFactAttribute ()
			: this(default(string[]))
		{
		}
		...
		/// </summary>
		public VsxFactAttribute (string visualStudioVersion)
		...
		/// </summary>
		public VsxFactAttribute (params string[] visualStudioVersions)
		{
