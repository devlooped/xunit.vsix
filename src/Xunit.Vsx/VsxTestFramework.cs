...
namespace Xunit
{
	class VsxTestFramework : XunitTestFramework
	{
		public VsxTestFramework (IMessageSink messageSink) : base (messageSink)
		{
		}
		...
		{
			return new VsxTestFrameworkExecutor (assemblyName, base.SourceInformationProvider, base.DiagnosticMessageSink);
		}

		class VsxTestFrameworkExecutor : XunitTestFrameworkExecutor
		{
			public VsxTestFrameworkExecutor (AssemblyName assemblyName,
			...
			protected override async void RunTestCases (IEnumerable<IXunitTestCase> testCases, IMessageSink executionMessageSink, ITestFrameworkExecutionOptions executionOptions)
			{
				...
				using (var assemblyRunner = new VsxTestAssemblyRunner (TestAssembly, testCases, DiagnosticMessageSink, executionMessageSink, executionOptions))
