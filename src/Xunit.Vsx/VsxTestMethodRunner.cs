...
namespace Xunit
{
	class VsxTestMethodRunner : XunitTestMethodRunner
	{
		readonly IVsClient vsClient;
        readonly object[] constructorArguments;


		public VsxTestMethodRunner (IVsClient vsClient, ITestMethod testMethod, IReflectionTypeInfo @class, IReflectionMethodInfo method, IEnumerable<IXunitTestCase> testCases, IMessageSink diagnosticMessageSink, IMessageBus messageBus, ExceptionAggregator aggregator, CancellationTokenSource cancellationTokenSource, object[] constructorArguments)
		...
		{
			return vsClient.RunAsync((VsxTestCase)testCase, MessageBus, Aggregator, constructorArguments);
		}
